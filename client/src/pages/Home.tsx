    ...
    <>
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        <a href="#" className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm mt-20">
          <span className="bg-green-800 text-xs px-3 py-1 rounded-full">NEW</span>
        ...
        <h1 className="text-center text-[40px] leading-[48px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-3xl text-lime-500">
          Build your dream site in seconds with Codeyen AI.
        </h1>

        <p className="text-center text-base max-w-md mt-2">
          Unleash your creativity. Let Codeyen handle the code.
        </p>

        <form onSubmit={onSubmitHandler} className="bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10 border border-green-600/70 focus-within:ring-2 ring-green-500 transition-all">
          ...
          <button className="ml-auto flex items-center gap-2 bg-gradient-to-r from-[#CB52D4] to-green-600 rounded-md px-4 py-2">
